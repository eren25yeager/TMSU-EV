document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- PDF Generation (Screenshot Method) ---
    ...
    function displayResults(data) {
        ...
        if (photoUrl.includes('drive.google.com')) {
            ...
            if (fileId) photoUrl = `https://lh3.googleusercontent.com/d/${fileId}`;
        }
    ...
    if (inputs.code) {
        ...
        if (inputWrapper && caret) {
            const updateCaretPosition = () => {
                ...
                // Center the caret based on the text width
                const newLeft = (inputs.code.offsetWidth / 2) + (textWidth / 2) + 2; // +2 for spacing
