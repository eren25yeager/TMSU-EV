document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- PDF Generation (Screenshot Method - FINAL VERSION) ---
    function generateAndDownloadPDF(memberName) {
        ...
        resultsContainer.classList.add('pdf-render-mode'); // Force desktop layout
        ...
        html2canvas(resultsContainer, {
            ...
            // 4. Clean up
            resultsContainer.classList.remove('pdf-render-mode'); // Revert to responsive layout
